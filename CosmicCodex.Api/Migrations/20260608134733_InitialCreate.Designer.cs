...
namespace CosmicCodex.Api.Migrations
{
    ...
    [Migration("20260608134733_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CosmicCodex.Api.Models.Planet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CosmicCodex.Api.Models.StarSystem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CosmicCodex.Api.Models.Planet", b =>
                {
                    b.HasOne("CosmicCodex.Api.Models.StarSystem", "StarSystem")
                        .WithMany("Planets")
